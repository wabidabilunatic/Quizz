    ...
    class QuizzTesterController
    {
       ...
       //if question is correct
         ...
         {                    {
                     ...
                     return $app['twig']->render('test.html.twig', array('question' =>  $question,'category'=>$category,'numTest'=>$numTest,'numQuestion'=>$numQuestion,'numberOfQuestions'=>$numberOfQuestions,'correctAnswers'=>$correctAnswers,'finished'=>$finished,'totalCorrects'=>$totalCorrects));
